...
if (!isset($_SESSION['seller_email'])) {
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top"><!-- navbar navbar-inverse navbar-fixed-top Starts -->
        ...
        <div class="navbar-header"><!-- navbar-header Starts -->
            ...
            <a class="navbar-brand" href="index.php?dashboard">seller Panel Glassify</a>
            ...
            <ul class="nav navbar-nav side-nav"><!-- nav navbar-nav side-nav Starts -->
                ...
                <li><!-- li Starts -->
                    ...
                    <a href="index.php?test">
                        ...
                        <i class="fa fa-fw fa-spinner"></i> view orders
                ...
                <li><!-- li Starts -->
                    ...
                    <a href="index.php?order_items">

                        <i class="fa fa-fw fa-list"></i> view ordered items
