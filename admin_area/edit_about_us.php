...
if (!isset($_SESSION['admin_email'])) {
  ...
  <?php echo $about_desc; ?>
            ...
            <div class="form-group"><!-- form-group Starts -->
              ...
              <div class="col-md-8">
                ...
                <input type="file" accept="*/image" name="about_image" class="form-control" value="<?php echo $about_image; ?>">
  ...
  if (isset($_POST['submit'])) {
    ...
    $update_about_us = "update about_us set about_heading='$about_heading',about_short_desc='$about_short_desc',about_desc='$about_desc',about_image='$about_image'";
